...
var $author$project$Cursor$fromList = function (lst) {
	if (!lst.b) {
		return $elm$core$Maybe$Nothing;
	} else {
		var x = lst.a;
				...
				switch (_v1.b.$) {
					...
					default:
						if (_v1.a.$ === 'LoadedPosts') {
							...
							var filteredPosts = A2($author$project$Model$PostsConfig$filterPosts, updatedConfig, state.posts);
							return _Utils_Tuple2(
								$author$project$Model$LoadedPosts(
									_Utils_update(
										state,
										{config: updatedConfig, posts: filteredPosts})),
								$author$project$Effect$NoEffect);
						} else {
							break _v1$4;
						}
...
var $author$project$Util$Time$durationBetween = F2(
	function (t1, t2) {
		if (_Utils_cmp(
			...
			var hours = ((totalSeconds % ((24 * 60) * 60)) / (60 * 60)) | 0;
			var minutes = ((totalSeconds % (60 * 60)) / 60) | 0;
...
var $author$project$View$Posts$maybeLink = function (maybeUrl) {
	if (maybeUrl.$ === 'Just') {
		var url = maybeUrl.a;
		return A2(
			$elm$html$Html$a,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							_Utils_ap(formattedTime, relativeDuration))
						])),
					A2(
					$elm$html$Html$td,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$author$project$View$Posts$maybeLink(post.url)
						]))
				]));
	});
...
var $author$project$View$Posts$postsToShowOption = F2(
...
var $author$project$View$Posts$sortByOption = F2(
	function (selected, value) {
		return A2(
			$elm$html$Html$option,
			_List_fromArray(
						...
						_List_fromArray(
							[
								...
								A2(
									...
									A2(
										$elm$core$Basics$composeL,
										A2($elm$core$Basics$composeL, $author$project$Model$ConfigChanged, $author$project$Model$PostsConfig$ChangePostsToShow),
										$elm$core$Maybe$withDefault(10)),
									$elm$core$String$toInt))
							]),
						A2(
							$elm$core$List$map,
							$author$project$View$Posts$postsToShowOption(config.postsToShow),
							_List_fromArray(
								[10, 25, 50])))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onInput(
								function (input) {
									var _v0 = $author$project$Model$PostsConfig$sortFromString(input);
									if (_v0.$ === 'Just') {
										var sortBy = _v0.a;
						...
						A2(
							$elm$core$List$map,
							$author$project$View$Posts$sortByOption(config.sortBy),
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($elm$core$Basics$composeL, $author$project$Model$ConfigChanged, $author$project$Model$PostsConfig$ChangeShowJobs))
							]),
						_List_Nil)
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onCheck(
								A2($elm$core$Basics$composeL, $author$project$Model$ConfigChanged, $author$project$Model$PostsConfig$ChangeShowTextOnly))
							]),
						_List_Nil)
					]))
			]));
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['C:\\BogdanC\\Facultate\\An3_sem1\\PF\\ELM_PROIECT\\tests\\ExampleTests\\CursorTests.elm', 'C:\\BogdanC\\Facultate\\An3_sem1\\PF\\ELM_PROIECT\\tests\\ExampleTests\\ModelPostIdsTests.elm', 'C:\\BogdanC\\Facultate\\An3_sem1\\PF\\ELM_PROIECT\\tests\\ExampleTests\\ModelPostsConfigTests.elm', 'C:\\BogdanC\\Facultate\\An3_sem1\\PF\\ELM_PROIECT\\tests\\ExampleTests\\UtilTimeTests.elm', 'C:\\BogdanC\\Facultate\\An3_sem1\\PF\\ELM_PROIECT\\tests\\MainTests.elm', 'C:\\BogdanC\\Facultate\\An3_sem1\\PF\\ELM_PROIECT\\tests\\PostsConfigTests.elm', 'C:\\BogdanC\\Facultate\\An3_sem1\\PF\\ELM_PROIECT\\tests\\PostsViewTests.elm', 'C:\\BogdanC\\Facultate\\An3_sem1\\PF\\ELM_PROIECT\\tests\\PostTests.elm', 'C:\\BogdanC\\Facultate\\An3_sem1\\PF\\ELM_PROIECT\\tests\\SimulatedEffect.elm', 'C:\\BogdanC\\Facultate\\An3_sem1\\PF\\ELM_PROIECT\\tests\\TestData.elm', 'C:\\BogdanC\\Facultate\\An3_sem1\\PF\\ELM_PROIECT\\tests\\TestUtils.elm']),
		processes: 12,
...
var pipeFilename = "\\\\.\\pipe\\elm_test-25224-1";
var net = require('net'),
